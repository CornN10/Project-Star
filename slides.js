window.onload = function () {
	...
	let half = Math.round(amount * 0.5);
...
/* have to fix the slideshow so that it works for more than 7 images. ->
?? not sure if need to fix pause/play button everytime user clicks on new webpage
make it fancier, images look nicer, option to press/zoom in on images etc.
the underline on the nav bar goes beyond it/nav bar doesn't look nice*/
